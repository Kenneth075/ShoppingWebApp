...
using Moq;
using ShoppingWebApp.TagHelpers;
using System;
...
namespace ShoppingWebAppTest.TagHelpers
{
    public class EmailTagHelperTest
    {
        ...
        {
            //Arrange
            EmailTagHelper emailTagHelper = new EmailTagHelper() { Address = "kennethtibele@gmail.com", Content = "Email" }; ;
            ...
            Assert.Equal("mailto:kennethtibele@gmail.com", tagHelperOutput.Attributes[0].Value);
        }
    }
}
